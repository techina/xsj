<?php /* Smarty version Smarty-3.1.11, created on 2014-05-06 18:28:13
         compiled from "D:\netbeans\yii\home\protected\views\tpl\cli\forum\info.html" */ ?>
<?php /*%%SmartyHeaderCode:210545368855defc3e4-17981527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e45e118c5f2503a562700d65664fd1b867a0b78c' => 
    array (
      0 => 'D:\\netbeans\\yii\\home\\protected\\views\\tpl\\cli\\forum\\info.html',
      1 => 1399365323,
      2 => 'file',
  ...
  'nocache_hash' => '210545368855defc3e4-17981527',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_5368855e158155_66459708',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5368855e158155_66459708')) {function content_5368855e158155_66459708($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>要成才 - 找新视界 - 帖子详情</title>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['info']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
<div class="infodet">
<div class='photo'>
<img src="<?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['userpic'];?>
" class="up">
<p><?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['rname'];?>
</p>
</div>
<div class='forumdet'>
<div class='ititle'><span class="ftile"><?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['title'];?>
</span>
<span class="flou">
[<a href="./index.php?r=forum&un=<?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['username'];?>
">只看楼主</a>]
<?php if ($_SESSION['userinfo']['username']==$_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['username']){?>
|&nbsp;[<a href="./index.php?r=forum/del&id=<?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['id'];?>
">删除</a>]<?php }?>
</span></div>
<div class='itime'>
发布于 <?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['ftime'];?>

</div>
<div class='icontent'><?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['content'];?>
</div>
<div class='ilike'><a href="javascript:;" onclick="javascript:addcol(<?php echo $_smarty_tpl->tpl_vars['info']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['id'];?>
)" id="addlike"></a></div>
</div>
</div>
<?php endfor; endif; ?>
...
<?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['us'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['us']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['name'] = 'us';
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['cinfo']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['us']['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['step'] = 1;
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['start'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['us']['step'] > 0 ? 0 : $_smarty_tpl->tpl_vars['smarty']->value['section']['us']['loop']-1;
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['last']       = ($_smarty_tpl->tpl_vars['smarty']->value['section']['us']['iteration'] == $_smarty_tpl->tpl_vars['smarty']->value['section']['us']['total']);
?>
<div class="infodet" id="<?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['id'];?>
">
<div class='photo'>
<img src="<?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['userpic'];?>
" class="up">
<p><?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['rname'];?>
</p>
</div>
<div class='forumdet'>
<div class='ititle'><span>回复于 <?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['ctime'];?>
</span>
<span class="flou">
[<a href="./index.php?r=forum&un=<?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['username'];?>
">只看楼主</a>]
<?php if ($_SESSION['userinfo']['username']==$_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['username']||$_SESSION['userinfo']['userlevel']=='admin'){?>
|&nbsp;[<a href="javascript:;" onclick="javascript:deletecomment(<?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['id'];?>
)">删除</a>]<?php }?>
</span></div>
<div class='icontent'><?php echo $_smarty_tpl->tpl_vars['cinfo']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['content'];?>
</div>
</div>
</div>
<?php endfor; endif; ?>
...
<form action="./index.php?r=comment/add" method="post" onsubmit="return checkpub();">
                                <input type="hidden" name="forumid" value="<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
"/>
