<?php /* Smarty version Smarty-3.1.11, created on 2014-05-08 14:31:49
         compiled from "/var/www/yii/protected/views/tpl/cli/index.html" */ ?>
<?php /*%%SmartyHeaderCode:762704597536b24d5475843-04151543%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '84fe521b2246131c17acce5a25b3a6d3d6598afb' => 
    array (
      0 => '/var/www/yii/protected/views/tpl/cli/index.html',
      1 => 1398395632,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '762704597536b24d5475843-04151543',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_536b24d5538254_16316384',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_536b24d5538254_16316384')) {function content_536b24d5538254_16316384($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>要成才 - 找新视界 - 首页</title>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['us']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['hlist']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<li class='jobinfo'>
<span style='float:left'><span class="hot"></span>&nbsp;&nbsp;<a href="./index.php?r=forum/info&id=<?php echo $_smarty_tpl->tpl_vars['hlist']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['hlist']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['title'];?>
</a></span>
<span style='float:right;margin-right:20px'><?php echo $_smarty_tpl->tpl_vars['hlist']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['ftime'];?>
</span>
<span style='float:right;margin-right:20px'><a href="./index.php?r=forum&un=<?php echo $_smarty_tpl->tpl_vars['hlist']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['username'];?>
" onmousemove="javascript:getUserInfo('<?php echo $_smarty_tpl->tpl_vars['hlist']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['username'];?>
',event)"  onmouseout="javascript:hiddenUserInfo()"><?php echo $_smarty_tpl->tpl_vars['hlist']->value[$_smarty_tpl->getVariable('smarty')->value['section']['us']['index']]['rname'];?>
</a></span>
</li>
<?php endfor; else: ?>
<li class='jobinfo'>
...
?>
<li class='jobinfo'>
<span style='float:left'><span class="new"></span>&nbsp;&nbsp;<a href="./index.php?r=forum/info&id=<?php echo $_smarty_tpl->tpl_vars['p']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['p']->value['title'];?>
</a></span>
<span style='float:right;margin-right:20px'><?php echo $_smarty_tpl->tpl_vars['p']->value['ftime'];?>
</span>
<span style='float:right;margin-right:20px'><a href="./index.php?r=forum&un=<?php echo $_smarty_tpl->tpl_vars['p']->value['username'];?>
" onmouseover="javascript:getUserInfo('<?php echo $_smarty_tpl->tpl_vars['p']->value['username'];?>
',event)" onmouseout="javascript:hiddenUserInfo()"><?php echo $_smarty_tpl->tpl_vars['p']->value['rname'];?>
</a></span>
</li>
<?php }
