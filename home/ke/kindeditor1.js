...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var t_n=url.substring(pos+1);
		var t_name=t_n.substring(3);
		var purl=path+t_name;
		var html = '<a href="'+_escape(purl)+'" target="_blank"><img src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
		if (width) {
